...
🌱 **Currently learning:** Deep diving into **Data Structures & Algorithms** and sharpening my **Java** skills.  
💬 **Ask me about:** Ruby on Rails, MySQL, Java, and JavaScript.  
⚡ **Fun fact:** I’ve got a "Can't stop, won't stop" mindset—fully focused on the journey to **MAANG**.  
📫 **How to reach me:** Drop a mail to **itagipramod@gmail.com** or connect with me via the social platforms below.
...
### [🚀 Retroreflect](https://github.com/pramoditagi/retroreflect)
*A dedicated dashboard to streamline and automate Agile retrospective meetings.*
...
### [☁️ Serverless AWS API](https://github.com/pramoditagi)
*A high-concurrency API built with a focus on cost-optimization and scalability.*
